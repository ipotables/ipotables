...
Module.prototype.addInput = function (thing, callback) {
    this._node.createRelationshipTo(thing._node, 'inputs', {}, function (err, rel) {
        callback(err);
    });
};
...
Module.prototype.removeInput = function (thing, callback) {
    var query = [
        'MATCH (module:Module) -[rel:inputs]-> (thing:Module)',
